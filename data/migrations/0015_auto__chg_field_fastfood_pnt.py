...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FastFood.pnt'
        db.alter_column(u'data_fastfood', 'pnt', self.gf('django.contrib.gis.db.models.fields.PointField')(srid=4269))

    def backwards(self, orm):

        # Changing field 'FastFood.pnt'
        db.alter_column(u'data_fastfood', 'pnt', self.gf('django.contrib.gis.db.models.fields.PointField')())
    ...
    models = {
        ...
        'data.fastfood': {
            'Meta': {'object_name': 'FastFood'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'loader_id': ('django.db.models.fields.IntegerField', [], {}),
            'pnt': ('django.contrib.gis.db.models.fields.PointField', [], {'srid': '4269'})
        }
    }
