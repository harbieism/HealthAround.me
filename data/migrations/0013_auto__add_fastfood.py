...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FastFood'
        db.create_table(u'data_fastfood', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pnt', self.gf('django.contrib.gis.db.models.fields.PointField')()),
        ))
        db.send_create_signal('data', ['FastFood'])


    def backwards(self, orm):
        # Deleting model 'FastFood'
        db.delete_table(u'data_fastfood')
    ...
    models = {
        ...
        'data.fastfood': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pnt': ('django.contrib.gis.db.models.fields.PointField', [], {})
        }
    }
